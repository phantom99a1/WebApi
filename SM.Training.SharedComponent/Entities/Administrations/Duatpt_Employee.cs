...
{
    public class Duatpt_Employee : BaseEntity
    {
        #region Premitive members
        ...
        public Duatpt_Employee() : base("DUATPT_EMPLOYEE", "EMPLOYEE_ID", C_DELETED, C_VERSION) { }
        ...
        public Duatpt_Employee CloneToUpdate()
        {
            Duatpt_Employee newItem = new Duatpt_Employee();
